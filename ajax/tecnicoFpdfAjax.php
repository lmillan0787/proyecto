...
function Footer()
{
    ...
    $this->SetTextColor(248,246,249);
     ...
     $this->Image('../views/assets/img/tecnicos.png',1.5,82,10,10,'png');
    //$this->Cell(90,45,'DEPORTISTA',0,1,'C');
    $this->Cell(95,45,utf8_decode('TÉCNICO'),0,1,'C');
...
$pdf->SetY(64);
$pdf->SetX(2);
$pdf->Cell(40,5,'Cargo:',0);
$pdf->Ln(0);
$pdf->SetX(18);
$pdf->Cell(40,5,utf8_decode(mb_strtoupper($_POST['des_carg'],'UTF-8')),0);
$pdf->Ln(5);

$pdf->SetY(69);
$pdf->SetX(2);
$pdf->Cell(40,5,utf8_decode('Institución:'),0);
$pdf->Ln(0);
$pdf->SetX(20);
$pdf->Cell(45,5,utf8_decode(mb_strtoupper($_POST['siglas'])),0);

$pdf->SetY(74);
$pdf->SetX(2);
$pdf->Cell(40,5,'Fecha de Evento:',0);
$pdf->Ln(0);
$pdf->SetX(30);
$pdf->Cell(40,5,utf8_decode(mb_strtoupper($_POST['fec_even'])),0);
