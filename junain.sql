...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2019 a las 19:30:29
...
--
ALTER TABLE `dat_even`
  MODIFY `cod_even` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
ALTER TABLE `dat_del`
  ...
  ADD CONSTRAINT `dat_del_ibfk_5` FOREIGN KEY (`cod_dis_even`) REFERENCES `tab_dis_even` (`cod_dis_even`) ON UPDATE CASCADE;
