...
$insPersaona = new formularioPersona();
...
<div class="card" id="form_ini">
    ...
    <div class="card-body px-lg-5">
        <form class="FormularioAjax" action="<?php echo SERVERURL ?>ajax/editarPersonaAjax.php" method="POST" data-form="editar" autocomplete="off" enctype="multipart/form-data">
