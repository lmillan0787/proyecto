...
<div class="card" id="form_ini">
    ...
    <div class="card-body px-lg-5">
        <form class="FormularioAjax" action="<?php echo SERVERURL ?>vistaPrueba/" method="POST" data-form="guardar" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="text" hidden="" name="cod_per" value="26">
            <input type="text" hidden="" name="cod_even" value="43">
            <input type="text" hidden="" name="cod_perf" value="14">
