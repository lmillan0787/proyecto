...
<form class="text-center" style="color: #757575;"  action="../process/reg_bas2.php" method="POST">
  <center>
<fieldset>
...
<div class="input-group mb-3">
  <div class="col-sm-10">
  <div class="input-group-prepend">
                <input type="text" id="ape" class="form-control" name="ape" placeholder="Apellido" minlength="4" maxlength="30" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+"> 
