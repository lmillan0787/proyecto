        ...
        <input type="text" hidden value="<?php echo $cod_par?>" name="cod_par">
            ...
            <div class="input-group flex-nowrap">
                ...
                <select name="cod_inst" id="selpue" class="form-control" required>
                    <?php
                    $insPart->formulario_participacion_editar_institucion_controlador($cod_par);
                    $insPart->formulario_participacion_editar_institucion_distinta_controlador($cod_par);
                    ?>
                </select>
            </div>
            <!-- cargo -->
            ...
            <div class="input-group flex-nowrap">
                ...
                <select name="cod_carg" id="cod_carg" class="form-control" required>
                    <?php
                    $insPart->formulario_participacion_editar_cargo_controlador($cod_par);
                    $insPart->formulario_participacion_editar_cargo_distinto_controlador($cod_par);
                    ?>
                </select>
            </div>
            <!-- Estatus-->
