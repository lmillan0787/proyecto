...
<nav class="navbar navbar-dark unique-color">
    ...
    <button class="btn btn-outline-white btn-md my-2 my-sm-0 ml-3" type="submit" onclick="location.href='<?php echo SERVERURL ?>registrarParticipacion/'">Registrar</button>
</nav>
<!-- Tabla -->
