...
<div class="card" id="form_invi">
    <h5 class="card-header info-color white-text text-center py-4">
        <strong>Datos Básicos del Delegado</strong>
    </h5>
        ...
        <form class="FormularioAjax" action="<?php echo SERVERURL ?>ajax/editarDelegadoAjax.php" method="POST" data-form="guardar" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="input-group flex-nowrap">
                ...
                <select name="cod_dis" id="seldis" class="form-control" required>
                    <?php
                    $insPart->formulario_participacion_editar_disciplina_controlador($cod_par);
                    $insPart->formulario_participacion_editar_disciplina_distinto_controlador($cod_par);
                    ?>
                </select>
            </div>
  
                <select name="cod_cat" id="seldis" class="form-control" hidden required>
                    <?php
                    $insPart->formulario_participacion_editar_categoria_controlador($cod_par);
                    $insPart->formulario_participacion_editar_categoria_distinta_controlador($cod_par);
                    ?>
                </select>
