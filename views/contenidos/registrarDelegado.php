...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Datos de Paticipación</a>
    </li>
    <li class="nav-item">
    ...
    <div class="card-body">
        <div class="card" id="form_ini">
            ...
            <div class="card-body px-lg-5" >
                ...
                <div class="form-group">
                    <div class="col-sm-15">
                        <?php $insDelegado->consultarEvento();?>
                    </div>
                    <div>
                        <center><input type="submit" class="btn btn-primary" value="Registrar"></center>
                    </div>
            ...
            <div class="card-body px-lg-5" >
                ...
                <div class="form-group">
                    <div class="col-sm-15">
                        ...
                        <div class="input-group-prepend">
                            <?php $insDelegado->consultarRegion(); ?>
                        </div>
                    </div>
                </div>
                <!-- Select Pueblo -->
                <div class="form-group">
                    <div class="col-sm-15">
                        ...
                        <div class="input-group-prepend">
                            <?php $insDelegado->consultarPueblo(); ?>
                        </div>
                    </div>
                </div>
                <!-- Select Disciplina -->
                <div class="form-group">
                    <div class="col-sm-15">
                        ...
                        <div class="input-group-prepend">
                            <?php $insDelegado->consultarDisciplina(); ?>
                        </div>
                    </div>
                </div>
                <!-- Select Categoria -->
                <div class="form-group">
                    <div class="col-sm-15">
                        ...
                        <div class="input-group-prepend">
                            <?php $insDelegado->consultarCategoria(); ?>
                        </div>
                    </div>
                    <div>
                        <center><input type="submit" class="btn btn-primary" value="Registrar"></center>
